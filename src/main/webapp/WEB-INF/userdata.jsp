...
<head>
	...
	<body class="align">
		<div class="site__container" style="position: absolute; top:10%;left:40%">
			<div class="grid__container">
				<img class="logo" src="img/G.png" />
				<%Admin a =(Admin)request.getAttribute("ad"); %>
					<form _lpchecked="1" accept-charset="UTF-8" action="userData.do" class="form form--login" method="post">
						<div class="form__field">
							<input autofocus="true" class="form__input" id="login__name" name="Name" value="<%=a.getName() %>" placeholder="用户名" required="" type="text" style="background:rgba(255,255,254,.3);"/>
						</div>
						<div class="form__field">
							<input autocomplete="off" class="form__input" id="login__password" name="Password" value="<%=a.getPassword() %>" placeholder="密码 " required="" type="text" style="background:rgba(255,255,254,.3);"/>
                        </div>
                        <div class="form__field">
							<input autocomplete="off" class="form__input" id="login__email" name="Email" value="<%=a.getEmail() %>" placeholder="邮箱" required="" type="text" style="background:rgba(255,255,254,.3);"/>
                        </div>
                        <div class="form__field">
							<input autocomplete="off" class="form__input" id="login__tel" name="Telephone" value="<%=a.getTelephone() %>" placeholder="电话号码 " required="" type="text" style="background:rgba(255,255,254,.3);"/>
						</div>
						<div class="form__field">							
							<input type="submit" value="完 成 修 改" />
						</div>
					</form>
