		...
		<div class="site__container" style="position: absolute; top:10%;left:40%">
			<div class="grid__container">
				<img class="logo" src="img/G.png" />
					<form _lpchecked="1" accept-charset="UTF-8" action="login.do" class="form form--login" method="post">
						<div class="form__field">
							<input autofocus="true" class="form__input" id="login__name" name="username" placeholder="用户名" required="" type="text" style="background:rgba(255,255,254,.3);"/>
						</div>
						<div class="form__field">
							<input autocomplete="off" class="form__input" id="login__password" name="password" placeholder="密码 " required="" type="password" style="background:rgba(255,255,254,.3);"/>
						</div>
						<div class="form__field">							
							<input type="submit" value="登 录" style="background:rgba(255,255,254,.3);"/>
						</div>
					</form>
					
					<p class="text--center">还没有帐号?<a href="toRegist.do">点击注册</a></p>
			</div>
		</div>
		<!----背景效果---->
