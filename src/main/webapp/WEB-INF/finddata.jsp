...
<head>
	...
	<body class="align">
		<div class="site__container" style="position: absolute; top:0%;left:40%">
			<div class="grid__container">
				<img class="logo" src="img/G.png" />
				<%Admin a =(Admin)request.getAttribute("ad"); %>
					<form _lpchecked="1" accept-charset="UTF-8" action="findData.do" class="form form--login" method="post">
